...
class Figures (var figureDrawables: Array<Drawable>, var size:Int, val isBlack:Boolean) {
            ...
            if(newDestPosition!=null) {
                ...
                if(validMoves.isValid(newDestPosition!!) ) {
                    ...
                    if(movePositions.isNotEmpty())
                        movePositions = movePositions +" " + oldPosition + selectedFigure!!.chessPosition
                    else
    ...
    suspend fun getOpponentMove():Boolean
    {
        ...
        if(responseMsg.length > movePositions.length) {
